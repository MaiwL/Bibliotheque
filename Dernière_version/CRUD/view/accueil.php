    ...
    <div class="row justify-content-center gap-5 mt-5">
      <div class=" px-0 mb-5" style="width: 18rem;">
        ...
        <div class="card-body">
          ...
          <a href="/nouveaute" class="souligner" style=" color:#E8C5B4;">Nouveautés</a>
        </div>
      </div>
      <div class=" px-0 mb-5" style="width: 18rem;">
        ...
        <div class="card-body">
          ...
          <a href="#" class="souligner" style=" color:#E8C5B4;">Coups de coeur</a>
        </div>
      </div>
      <div class=" px-0 mb-5" style="width: 18rem;">
        ...
        <div class="card-body">
          ...
          <a href="#" class="souligner" style="color:#E8C5B4;">Horaires et informations</a>
        </div>
      </div>
    </div>
    <ul>
