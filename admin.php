...
<div class="container justify-content-center">
    <div class="container row" style="margin-top:100px;">
        <div class="col d-flex justify-content-center ms-4">
            <a href="ajout.php"><img src="./Images/AjoutLivre.png" style="width:50px; height:50px;" alt=""></a>
        </div>
        <div class="col d-flex justify-content-center">
            <a href="supprimer.php"><img src="./Images/SupprimerLivre.png" style="width:50px; height:50px;" alt=""></a>
        </div>
        <div class="col d-flex justify-content-center">
            <a href="modifier.php"><img src="./Images/ModifierLivre.png" style="width:50px; height:50px;" alt=""></a>
        </div>
    </div>
</div>
